...
module.exports = {
	...defaultConfig,
	entry: {
		'assignment-editor': path.resolve(process.cwd(), 'src', 'assignment-editor', 'index.js'),
		'grading-interface': path.resolve(process.cwd(), 'src', 'grading-interface', 'index.js'),
		...
		'blocks/assignment/index': path.resolve(process.cwd(), 'blocks', 'assignment', 'index.js'),
		'blocks/my-submissions/index': path.resolve(process.cwd(), 'blocks', 'my-submissions', 'index.js'),
	},
	output: {
